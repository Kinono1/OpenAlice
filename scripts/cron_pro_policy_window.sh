...
LOCK_DIR="$REPO_ROOT/data/runtime/locks/pro_policy_window.lock"
LOG_DIR="$REPO_ROOT/logs/cron"
LOG_FILE="$LOG_DIR/pro_policy_window.log"
REPORT_PATH="$REPO_ROOT/data/runtime/pro_policy_window.latest.json"
NOTIFICATION_PATH="$REPO_ROOT/data/runtime/pro_policy_window_notification.json"
