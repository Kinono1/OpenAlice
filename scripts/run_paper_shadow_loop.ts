...
export function buildStepPlan(args: CliArgs): StepPlan[] {
  return [
    ...
    {
      id: 'accumulate_1m_data',
      command: 'corepack',
      args: ['pnpm', 'data:accumulate-1m'],
      skipped: args.skipData,
      skipReason: 'skipData=true',
    },
    {
    ...
    {
      id: 'paper_volume_breakout_v2',
      command: 'corepack',
      args: ['pnpm', 'paper:volume-breakout-v2'],
    ...
    },
    {
      id: 'paper_low_vol',
      command: 'corepack',
      args: ['pnpm', 'paper:low-vol'],
      skipped: args.skipPaper,
      skipReason: 'skipPaper=true',
    },
    {
      id: 'paper_factor_ensemble',
      command: 'corepack',
      args: ['pnpm', 'paper:factor-ensemble'],
      skipped: args.skipPaper,
      skipReason: 'skipPaper=true',
    },
    {
      id: 'paper_breakout_1m',
      command: 'corepack',
      args: ['pnpm', 'paper:breakout-1m'],
      skipped: args.skipPaper,
      skipReason: 'skipPaper=true',
    },
    {
      id: 'paper_panic_index',
      command: 'corepack',
      args: ['pnpm', 'paper:panic-index'],
      skipped: args.skipPaper,
      skipReason: 'skipPaper=true',
    },
    {
      id: 'paper_funding_arb',
      command: 'corepack',
      args: ['pnpm', 'paper:funding-arb'],
      skipped: args.skipPaper,
      skipReason: 'skipPaper=true',
    },
    {
      id: 'paper_pairs_trading',
      command: 'corepack',
      args: ['pnpm', 'paper:pairs-trading'],
      skipped: args.skipPaper,
      skipReason: 'skipPaper=true',
    },
    {
      id: 'paper_ml',
      command: 'bash',
      args: ['scripts/paper_trade_ml.sh'],
      skipped: args.skipPaper,
      skipReason: 'skipPaper=true',
    },
    {
      id: 'paper_ml_lstm',
      command: 'bash',
      args: ['scripts/paper_trade_ml_lstm.sh'],
      skipped: args.skipPaper,
      skipReason: 'skipPaper=true',
    },
    {
    ...
    {
      id: 'paper_range_scalper',
      command: 'corepack',
      args: ['pnpm', 'paper:range-scalper'],
      skipped: args.skipPaper,
      skipReason: 'skipPaper=true',
    },
    {
