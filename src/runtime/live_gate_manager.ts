...
export type LiveGateManagerOptionsConfig =
  Omit<Partial<LiveGateManagerConfig>, "executionGate" | "regimeShift" | "deploymentRamp"> & {
...
export type LiveGateManagerConfigOverride = LiveGateManagerOptionsConfig;
