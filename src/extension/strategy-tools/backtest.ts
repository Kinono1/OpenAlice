...
function toRequiredParams(
  ...
  return {
    ...
    trendConfirmBars: r.trendConfirmBars,
    trendMinDiffPct: r.trendMinDiffPct,
    regimeVolWindow: r.regimeVolWindow,
    regimeAtrPeriod: r.regimeAtrPeriod,
    regimeFastPeriod: r.regimeFastPeriod,
    regimeSlowPeriod: r.regimeSlowPeriod,
    allowedEntryRegimes: r.allowedEntryRegimes,
    exitOnRegimeMismatch: r.exitOnRegimeMismatch,
