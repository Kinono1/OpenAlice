...
/**
 * Extract realized PnL from a CCXT balance payload across exchange-specific fields.
 * Returns 0 when no recognized realized-PnL field is present.
 */
